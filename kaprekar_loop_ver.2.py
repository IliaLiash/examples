...
def kaprekar_loop(n):
    ...
    if n in [100, 1000, 100000]:
        return print("Îøèáêà! Íà âõîä ïîäàíî ÷èñëî {}, íå óäîâëåòâîðÿþùåå óñëîâèÿì ïðîöåññà Êàïðåêàðà".format(n))
    if len(set(str(n))) == 1:
        return print("Îøèáêà! Íà âõîä ïîäàíî ÷èñëî {}, íå óäîâëåòâîðÿþùåå óñëîâèÿì ïðîöåññà Êàïðåêàðà".format(n))
    ...
    while n not in [495, 6174, 549945, 631764]:
        ...
        if n in list1:
            print("Ñëåäóþùåå ÷èñëî - {}, êàæåòñÿ ïðîöåññ çàöèêëèëñÿ...".format(n))
            break
        else: 
            print(n)
            list1.append(n)
